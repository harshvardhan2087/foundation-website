...
"[project]/lib/teamService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getAllMainMenus() {
    try {
        const menuQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "menuItems"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])("type", "==", "main"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])("order"));
        const menuSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(menuQuery);
        const items = [];
        menuSnapshot.forEach((doc)=>{
            items.push(getDocData(doc));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$teamService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/teamService.ts [app-client] (ecmascript)");
;
...
function Navigation() {
        ...
        "Navigation.useEffect": ()=>{
            const loadData = {
                "Navigation.useEffect.loadData": async ()=>{
                    try {
                        const mainMenus = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$teamService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllMainMenus"])();
                        // Load children for each main menu
                        const menusWithChildren = await Promise.all(mainMenus.map({
                            "Navigation.useEffect.loadData": async (menu)=>{
                                const children = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$teamService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getChildMenus"])(menu.id);
                                // Load grandchildren for each child
                                const childrenWithGrandchildren = await Promise.all(children.map({
                                    "Navigation.useEffect.loadData": async (child)=>{
                                        const grandchildren = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$teamService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getChildMenus"])(child.id);
                                        return {
                                            ...child,
    ...
    const renderDesktopTeamMenu = ()=>{
        ...
        return menuItems.map((menu)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    menu.children && menu.children.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: menu.children.map((child)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: `/team/${child.id}`,
                                    ...
                                    child.children && child.children.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "ml-4 mt-1 space-y-1",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                menuItems.length === 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Navigation, "kMD3Z72PP1DAl+bICRLf3rndZRQ=");
_c = Navigation;
var _c;
...
//# sourceMappingURL=_de345c88._.js.map